    ...
    <>
      {editFormVisibility === false ? (
        <form className="form-group custom-form" onSubmit={handleSubmit}>
          <label className="p-4">Add your todo-items</label>
          <div className="input-and-btn">
            ...
            />
            <button type="submit" className="btn btn-secondary btn-md space">
              ADD
            </button>
          </div>
        </form>
        ...
        <form className="form-group custom-form" onSubmit={editSubmit}>
          <label className="p-4">Update your todo-items</label>
          <div className="input-and-btn">
            <input
              type="text"
              className="form-control"
